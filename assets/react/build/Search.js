  ...
  _createClass(Search, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var isFiltered = Object.values(this.state.filters)
          .map(function (filter) {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('h1', { className: 'page-title' }, 'SEARCH'),
              React.createElement(
                'div',
              ...
              React.createElement(
                ...
                React.createElement(
                  'h4',
                  null,
                  React.createElement('strong', null, 'Sort')
                ),
                Object.entries(this.state.configuration.sortings).map(function (
                  sorting,
                  i
                ) {
                  ...
                  return React.createElement(
                    'label',
                    {
                      key: i,
                      className:
                        (isActive ? 'selected' : 'btn-light') + ' btn m-1 facet'
                    },
                    React.createElement('input', {
                      type: 'checkbox',
                      checked: isChecked,
              ...
              React.createElement(
                ...
                React.createElement(
                  'h4',
                  null,
                  React.createElement('strong', null, 'Filter')
                ),
                isFiltered &&
                  React.createElement(
                    'button',
              ...
              Object.entries(this.searchResult.data.aggregations).map(function (
                _ref
              ) {
                ...
                return React.createElement(
                  ...
                  React.createElement(
                    'h5',
                    null,
                    React.createElement('strong', null, value.title)
                  ),
                  React.createElement(
                    'div',
                    ...
                    Object.entries(value.buckets).map(function (_ref3) {
                      ...
                      if (valueB.key == '' || valueB.doc_count < 1) return

                      var isChecked =
                        _this2.state.filters[value.name].indexOf(valueB.key) >
                          -1 || false
            ...
            React.createElement(
              ...
              React.createElement(Pagination, {
                paginationData: this.searchResult.pagination,
                onSetPage: this.handleSetPage
              }),
              React.createElement(
                'div',
                null,
                Object.entries(this.searchResult.data.items).map(function (
                  _ref5
                ) {
    ...
    return function (event) {
      ...
      if (check) {
        ...
        if (urlVars[filterName]) {
          urlVars[filterName] = [].concat(
            _toConsumableArray(urlVars[filterName]),
            [filterValue]
          )
        } else {
